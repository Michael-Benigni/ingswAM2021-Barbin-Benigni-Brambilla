...
/**
 * Abstract class that represents a section of the faith track.
 * A section can be a classic one or a vatican report one.
 */
public abstract class Section {
     ...
     */
    Cell searchNextCellInSection(Cell currentCell)
            throws LastCellInSectionException, CellNotFoundInSectionException {
